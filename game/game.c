...
/*   Updated: 2021/08/18 19:04:58 by msuarez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_game_var(t_doom *doom)
{
...
// static void	debug_show_game_polymap(SDL_Surface *polymap, uint32_t *colors)			// remove for norm-friendly stage?
// {
// 	unsigned int	*dst;
// 	unsigned int	*pixels;
// 	unsigned int	col;
...
void	game_render(t_doom *doom)
{
	...
	// handle_player_invis_toggle(doom);	// TODO: Remove invis toggling ? Experimental feature cutting off from shipped build propably
