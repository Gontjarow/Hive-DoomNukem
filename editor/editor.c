...
//		load_model.c - static void lightknob_room(t_room *room);

// PROBLEM (B)
// 	BLUE EFFECTOR IN EDITOR EFFECTS IS THE KEYPANEL EFFECTOR
//	THE KEYPANEL LOCATES ONTO A WALL
...
// 	DISALLOW PLACING MORE KEYPANEL EFFECTORS ON THE SAME WALL AND CHECK WITH TARGET_ID
//	DISALLOW PLACING MORE THAN ONE KEYPANEL EFFECTOR ON THE SAME DOOR_PORTAL AND CHECK WITH TARGET_ID
...
//		both sides? one rank? two ranks? three ranks? four ranks? five ranks? test?
...
// TODO MISC FIXES, POSSIBLE FEATURES, CHECK LINE BY LINE
...
//	PHASE IV - POLISHING AND FINISHING
