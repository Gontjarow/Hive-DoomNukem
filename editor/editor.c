...
//	TODO FOR DELETE / UPDATE OPTIONS
//		PREVIEW TRAILING TAIL FOR ROTATABLES PLANTING // <-- YOU ARE HERE !!
//		ADJUST ROTATION FOR ROTATABLES
//			SINGLE CLICK THEN SINGLE CLICK AGAIN TO ASSIGN TAIL
//			PLANTING -> LEFT CLICK (CLOSE TO A PLANTING) -> LEFT CLICK
//		ENEMIES DOUBLE CLICK DELETE
//			LEFT CLICK THEN LEFT CLICK AGAIN FAST TO DELETE ENEMY
//		PICKUPS -> LEFT CLICK THEN LEFT CLICK AGAIN TO DELETE
//		SELECTION MODE TO FACILITATE DELETION OF ROOMS
//		DELETION, SELECTING ANOTHER OR DESELECTION
//		INPUT SYSTEM FOR HEIGHT OF BOTH SELECTED ROOM ROOF AND FLOOR
//			RENDER DIGITS VISIBLE FOR SELECTED ROOMS
//			RENDER BARYMETRIC CENTER FOR SELECTED ROOM
