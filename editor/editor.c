...
// TODO NOW
//		KNEE_HEIGHT MANAGEMENT FOR CROSSING ROOM BORDERS THAT ARE KNEEHEIGHT RANGE HIGHER THAN FLOOR HEIGHT
//		INFLIGHT/JUMPING CROSSING ROOM BORDERS WHERE POSSIBLE
//		BLOCKING CROSSING OF ROOM BORDERS WHEN TOO HIGH/BIG TO FIT AVAILABLE SPACE
...
// TODO PRIORITIZED ADDITIONS - PHASE 0
//		TIME BASED FIXES TO ANIMATION CODE, MOVEMENT CODE (MURILLO)
//		FLIGHT PACK ITEM PICKUP WITH HUD INFO ETC (MURILLO)
//		DISPLAY SPRITES FOR LEVEL EXIT (NIKO)
//		SKYBOX (NIKO)
//		INCLINED FLOOR AND ROOF AKA SLOPING ROOMS (NIKO)
//		INCLINATION SETTING IN EDITOR BY A HINGE OFF OF A SINGLE WALL OF A ROOM (KALLE)

// TODO SECONDARY ADDITIONS - PHASE 0
...
//		SHOOTABLE WALLS TO CREATE SECRET PASSAGES IN EDITOR

//	TODO FOR EFFECTORS - WORK WITH MURILLO TO INTEGRATE THESE INTO THE CAMPAIGN LEVELS - PHASE II
...
//		TODO FOR PORTALIZATION, DOORS, WINDOWS, TEXTURING IN EDITOR - PHASE III
...
//		MORE HELP AND GUI HINTS AND DOCUMENTATION IN EDITOR VIEW
//		NORMINETTING THE PROJECT CODE AND RETURNING TO SCHOOL REPOSITORY

// MOCKUP ELEVATOR EFFECT TYPE
// [Effect] id = 1 | type_id = 1 (EFFECT_ELEVATOR) | loc.x = button.x | loc.y = button.y
