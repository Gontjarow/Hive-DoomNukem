...
//	TODO
//		mockup [effect] id = 1 | type_id = 1 (EFFECT_ELEVATOR) | lox.x = button.x | loc.y = button.y | target.x = min_height | target.y = max_height | target_id = 0 (nothing) target_id = 1 (going up)
//		FIX APPLY_GRAVITY, KNEE_HEIGHT ETC.
//		FLOOR ROOF TEXTURE
